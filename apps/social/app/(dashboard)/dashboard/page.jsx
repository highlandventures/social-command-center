...
export default function DashboardPage() {
  ...
  return (
    <div>
      ...
      {/* Sentiment Drivers — brand-term grouped cards */}
      <div className="bg-surface-card rounded-xl border border-border p-5 mb-8">
        <SectionTitle subtitle="Sentiment breakdown by Figure ecosystem brand — where your brands are being mentioned">Brand Mention Sentiment</SectionTitle>
