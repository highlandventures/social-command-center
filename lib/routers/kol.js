...
export const kolRouter = router({
  ...
  list: protectedProcedure.query(async ({ ctx }) => {
    ...
    return kols.map((k) => {
      // Compute sentiment, engagement, and impressions from activations
      ...
      for (const a of acts) {
        ...
        totalImpressions += m.impressions || ((m.upvotes || 0) + (m.comments || 0)) * 10;
      }
      ...
      return {
        ...
        // Live-computed from activations (last 30 days)
