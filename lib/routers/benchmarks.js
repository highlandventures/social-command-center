...
const SEED_DATA = {
  ...
  your_accounts: [
    { handle: '@Figure', display_name: 'Figure', followers: 24944, engagement_rate_pct: 1.05, impressions_per_post: 8200, bookmarks_per_post: 6.2, distribution_score: 245, health_grade: 'B-' },
  ...
  your_accounts_vs_benchmarks: [
    { handle: '@Figure', display_name: 'Figure', metrics: { engagement_rate: { vs_median_pct: -41.7, vs_top_10_pct: -70.0 }, impressions: { vs_median_pct: -31.7, vs_top_10_pct: -81.8 }, bookmarks: { vs_median_pct: -31.1, vs_top_10_pct: -77.9 } } },
  ...
  universe_accounts: [
    ...
    { handle: '@Figure', display_name: 'Figure', engagement_rate_pct: 1.05, impressions_per_post: 8200, bookmarks_per_post: 6.2, distribution_score: 245, health_grade: 'B-' },
